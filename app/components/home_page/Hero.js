...
const Hero = () => {
  return (
    <div className="z-0 mt-36 md:mt-12 min-h-screen w-full px-8 md:px-16 lg:px-32 xl:px-36 2xl:px-96 bg-gray-50 flex items-center justify-between gap-24">
      {/* div text */}
      ...
      <div className="md:w-5/12 text-yellow-950 ">
        ...
        <p className="my-8">
          ...
          casă și o atmosferă caldă și primitoare.
        </p>
